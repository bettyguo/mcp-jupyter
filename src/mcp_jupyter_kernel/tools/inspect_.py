"""inspect — polymorphic kernel-value introspection. docs/tools.md #8.

This tool is the differentiation. Mode argument carries the privacy posture:
  auto    → safe summaries (shape/dtypes/head)
  summary → safe statistics (describe / value_counts / stats)
  value   → raw repr capped at 50 KB; description carries explicit warning.
"""
